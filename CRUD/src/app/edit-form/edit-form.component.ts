...
export class EditFormComponent implements OnInit {
 ...
 // reactive form in angular
  ...
  @Output() load_data_in_app:EventEmitter<any> = new EventEmitter() // it will help to load data when ever a user submit form
  @Input()
  user_Details:any
  ...
  @Input()
  update_check :string = "string" // for getting data from db
...
//###################################################################################################################################################
  // when ever  a form submit button is clicked then this function gona execute
